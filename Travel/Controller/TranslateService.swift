...
class TranslateService {
    ...
    func getTranslation(
        of input: String, _ fromLangage: Langage = .french,
        _ toLangage: Langage = .english, completion: @escaping (Result<TranslateJson, ApiError>) -> Void) {
        ...
        urlComponents.queryItems = [
            ...
            URLQueryItem(name: UrlQuery.source.rawValue, value: fromLangage.rawValue),
            URLQueryItem(name: UrlQuery.target.rawValue, value: toLangage.rawValue),
